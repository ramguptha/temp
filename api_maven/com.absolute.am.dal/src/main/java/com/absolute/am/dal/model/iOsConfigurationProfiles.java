...
public class iOsConfigurationProfiles implements Serializable {
	...
	@Column(name = "AppBundleIdentifier")
	private String appBundleIdentifier;
	
	@Column(name = "PerAppVPNUUID")
	private String perAppVPNUUID;
	...
	public String getPerAppVPNUUID() {
		return perAppVPNUUID;
	}
	public void setPerAppVPNUUID(String perAppVPNUUID) {
		this.perAppVPNUUID = perAppVPNUUID;
	}
