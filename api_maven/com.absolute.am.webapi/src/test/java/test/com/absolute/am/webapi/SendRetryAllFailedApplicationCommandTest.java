...
public class SendRetryAllFailedApplicationCommandTest extends LoggedInTest {

	private static final String SEND_RETRY_ALL_FAILED_APPLICATIONS_COMMAND_API = COMMANDS_API + "/retryallfailedapplications";
	private static final String NON_EXISTING_DEVICE_ID = "999999";

	@Test
	@Category(com.absolute.util.helper.FastTest.class)
	public void can_send_retry_all_failed_applications_command() throws Exception {
		...
		String response = Helpers.postJsonRequestGetResultCheckStatus(
					logonCookie, 
					Helpers.WEBAPI_BASE_URL + SEND_RETRY_ALL_FAILED_APPLICATIONS_COMMAND_API, sb.toString(),
					200, 299);
	...
	public void can_get_exception_with_missing_device_ids() throws Exception {
		...
		String response = Helpers.postJsonRequestGetResultCheckStatus(
				logonCookie, 
				Helpers.WEBAPI_BASE_URL + SEND_RETRY_ALL_FAILED_APPLICATIONS_COMMAND_API, 
				sb.toString(), 
