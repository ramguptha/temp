define([
  ...
  return AmSpec.extend({
    ...
    format: {
      ...
      // MAC
      instSoftwareInfo:  { labelResource: 'amData.computerInstalledSoftwareSpec.instSoftwareInfo', format: Format.StringOrNA }
    },
    ...
    searchableNames: 'instSoftwareName instSoftwareVersionString instSoftwareSize instSoftwareInstallationDate identificationType instSoftwareProductId instSoftwareInfo'.w()
