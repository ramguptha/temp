define([
  ...
  return AmSpec.extend({
    format: {
      id: Format.ID,
      guid: Format.Guid,
      name: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.name', format: Format.String },
      osPlatform: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.osPlatform', format: Format.SearchableIcon },
      category: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.category', format: Format.ShortString },
      minOsVersion: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.minOsVersion', format: Format.OSVersionPlus },
      shortDescription: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.shortDescription', format: Format.StringOrNA },
      longDescription: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.longDescription', format: Format.LongStringOrNA },
      icon: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.icon', format: Format.SearchableIcon },
      appStoreURL: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.appStoreURL', format: Format.LongHyperlinkToNewPage },
      isUniversal: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.isUniversal', format: Format.BooleanOrNA },
      supportedDevices: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.supportedDevices', format: Format.StringOrNA },
      preventDataBackup: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.preventDataBackup', format: Format.BooleanOrNA },
      removeWhenMDMIsRemoved: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.removeWhenMDMIsRemoved', format: Format.BooleanOrNA },
      hasRedemptionCode: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.hasRedemptionCode', format: Format.NumberToBooleanOrNA  },
      vppCodesPurchased: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.vppCodesPurchased', format: Format.NumberOrNA },
      vppCodesRedeemed: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.vppCodesRedeemed', format: Format.NumberOrNA },
      vppCodesRemaining: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.vppCodesRemaining', format: Format.NumberOrNA },
      assignmentRule: { labelResource: 'amData.thirdPartyApplicationsFromPolicySpec.assignmentRule', format: Format.StringOrNA }
    },
    ...
    searchableNames: 'name icon assignmentRule osPlatform category minOsVersion isUniversal supportedDevices shortDescription preventDataBackup removeWhenMDMIsRemoved vppCodesPurchased vppCodesRedeemed vppCodesRemaining'.w()
  }).create();
});
