define([
  ...
  return AmDesktop.ListControllerColumns.extend({
    ...
    userPrefsEndpointName: 'assignedInHouseAppListColumns',

    visibleColumnNames: 'appName policyName rule'.w(),

    dataStore: function () {
      return AmData.get('stores.mobileDeviceAssignedInHouseAppsStore');
    }.property(),

    parentController: Em.inject.controller('amMobileDeviceItem'),

    relatedListTitle: 'amMobileDevice.devicePage.assignedInHouseApplicationsTab.title'.tr(),
