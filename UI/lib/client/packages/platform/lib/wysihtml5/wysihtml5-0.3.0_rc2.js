...
wysihtml5.views.View = Base.extend(
  ...
  var dom             = wysihtml5.dom,
      ...
      ADDITIONAL_CSS_RULES = [
        ...
        ".wysiwyg-color-red {color: #B90003;}",
        ...
        "body             { padding: 10px; margin: 0; margin-top: -1px;background-color:transparent!important; text-align:center!important;height:100%;}",
        "._wysihtml5-temp { display: none; }",
        wysihtml5.browser.isGecko ?
          "body.placeholder {}" :
          "body.placeholder { padding:10px!important;background-color:transparent!important;}",
        "body[disabled]   { background-color: #F7F7F7 !important; cursor: default !important; }",
