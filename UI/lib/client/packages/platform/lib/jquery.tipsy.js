// [YS Jun 25, 2014] Please note that the plugin was upgraded to support JQuery 1.10 and modified to use improved auto-gravity and auto-bounds.
...
(function($, window, undefined) {
  ...
  $.fn.tipsy.autoNESW = function() {
    var $this = $(this);
    var $ew = $this.offset().left > ($(document).scrollLeft() + $(window).width() / 2) ? 'e' : 'w';
    var $sn = $this.position().top > ($(document).scrollTop() + $(window).height() / 2) ? 's' : 'n';
    return $sn+''+$ew;
  };
