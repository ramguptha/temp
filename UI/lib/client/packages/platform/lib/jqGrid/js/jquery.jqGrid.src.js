...
/**
 * [YS, Nov 29, 2013] - Please note that the file was modified to replace 'groupingToggle' method taken from
 * jqGrid  4.5.4 to fix 3d level collapsing bug.
 *
...
$.jgrid.extend({
	...
	groupingPrepare : function (rData, gdata, record, irow) {
        ...
        v = $t.formatter(null, record[fieldName], 0);
        if( v !== undefined ) {
					if(irow === 0 ) {
