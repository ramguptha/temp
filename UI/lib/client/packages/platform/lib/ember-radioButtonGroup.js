...
/** @scope Ember.RadioButton.prototype */ {
  ...
  attributeBindings: ["isDisabled:disabled", "type", "isSelected"],
  ...
  selectedValue: Ember.computed(function(key, value) {
    ...
    // setter
      ...
      if (!Ember.none(value)) {
        ...
        Ember.assert(fmt("%@ - selectedValue can only be set to the value of a radio button in the group. You passed %@", [this, value]), !!buttonForValue);
