  ...
  */
  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createNodeLi = function(node) {
        ...
        return $("<li class=\"" + class_string + "\"><div class=\"row-container\"><div class=\"jqtree-element jqtree_common\"><span class=\"jqtree-title jqtree_common\">" + escaped_name + "</span></div></div></li>");
      };
      createFolderLi = function(node) {
        ...
        return $("<li class=\"jqtree_common " + folder_classes + "\"><div class=\"row-container\"><div class=\"jqtree-element jqtree_common\"><a class=\"jqtree_common " + button_classes + "\">" + button_char + "</a><span class=\"jqtree_common jqtree-title\">" + escaped_name + "</span></div></div></li>");
      };
  ...
  FolderElement = (function(_super) {
    ...
    FolderElement.prototype.getButton = function() {
      return this.$element.children().children('.jqtree-element').find('a.jqtree-toggler');
    };
