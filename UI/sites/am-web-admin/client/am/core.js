define([
    ...
    actions: {
      logout: function() {
        Ajax.del(
          ...
          {},
          function(data) {
            window.document.location = '../login/?loggedOut=true';
          },
  ...
  App.setProperties({
    ...
    ApplicationView: AppFoundation.ApplicationView,

    // Landing
    // -------

    LandingController: LandingController,
    LandingView: Desktop.LandingPageView,
      ...
      init: function() {
        ...
        this.set('checkTimeout', function() {
          ...
          if (secsToExpiry > 0) {
            ...
            window.document.location = '../login/?sessionTimedOut=true';
          }
        });
      },
